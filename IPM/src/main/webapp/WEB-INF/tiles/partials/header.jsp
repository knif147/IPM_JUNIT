...
<a href="#" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
	<span class="logo-mini"><b>IPM</b></span> <!-- logo for regular state and mobile devices -->
	<span class="logo-lg"><b>IPM</b> system</span>
</a>
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown user user-menu">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
					<img src="<c:url value='/static/images/avatar.png' />" class="user-image" alt="User Image">
					...
					<li class="user-footer">
						<div class="pull-left">
							<sec:authorize access="hasRole('ROLE_1')">
								<c:url value="/admin/info" var="link"></c:url>
							</sec:authorize>
							<sec:authorize access="hasRole('ROLE_2')">
								<c:url value="/hr/info" var="link"></c:url>
							</sec:authorize>
							<sec:authorize access="hasRole('ROLE_3')">
								<c:url value="/interviewer/info" var="link"></c:url>
							</sec:authorize>
