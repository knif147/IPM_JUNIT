...
<section class="content-header">
	<h1>
		Candidate management <small>Update candidate's information</small>
	</h1>
	<ol class="breadcrumb">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							<!-- left -->
							<c:url value="/hr/candidate/update" var="action" />
							<form:form action="${action}" method="POST"
								modelAttribute="candidate" enctype="multipart/form-data">
								<form:hidden path="id"/>
								<form:hidden path="linkCV"/>
								...
								<div class="box-body">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div
												class="form-group ${not empty bdError ? 'has-error' :''}">
										...
										<div class="col-md-12">
											<div class="form-group">
												<button class="btn btn-flat btn-primary pull-right">
													<i class="fa fa-edit"></i> Update Candidate
												</button>
											</div>
										</div>
									</div>
