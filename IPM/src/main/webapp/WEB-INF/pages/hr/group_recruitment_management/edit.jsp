...
<section class="content-header">
	<h1>
		Recruitment group management <small>Update recruitment group</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<c:url value="/hr/recruiment" />"> <i
				class="fa fa-home"></i> Home
		</a></li>
		<li><a href="<c:url value="/hr/recruitment/group" />">Recruitment group management</a></li>
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Update Recruitment Group</h3>
				</div>
				<c:url value="/hr/recruitment/group/save" var="action" />
				<form:form action="${action}" method="GET" modelAttribute="groupRecruitment">
					<form:hidden path="id"/>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group ${not empty nameError ? 'has-error' :''}">
									<label>Name Recruitment Group</label>
							...
							<div class="col-md-12">
								<div class="form-group">
									<button class="btn btn-flat btn-primary">
										<i class="fa fa-edit"></i> Update Recruitment Group
									</button>
								</div>
							</div>
						</div>
