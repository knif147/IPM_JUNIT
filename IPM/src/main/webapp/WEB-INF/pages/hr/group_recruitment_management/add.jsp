...
<section class="content-header">
	<h1>
		Recruitment group management <small>Add recruitment group</small>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Add new Recruitment Group</h3>
				</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<button class="btn btn-flat btn-primary">
										<i class="fa fa-plus"></i> Create Recruitment Group
									</button>
								</div>
							</div>
						</div>
